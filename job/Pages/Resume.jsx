        ...
        <div className="container">
          ...
          <div className="resume-content">
            <div className="profile section clearfix">
              ...
              {/* How To use Componets with Props {{Properties}} You call the name of componet where you want it  */}
            <Profile name="Ichigo KuroSaki"
                     phone="0923456789"
                     />
            </div>
         

         <Career talk="Little Explanation to make me understand props and Components"/>
